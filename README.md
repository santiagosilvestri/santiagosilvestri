...
**Ingeniero Civil orientado a Sistemas de Información y desarrollo de software.**
...
- **42 Madrid** — Common Core  
  Programación, lógica, memoria, algoritmos, herramientas de línea de comandos y aprendizaje basado en proyectos.

- **Universidad del Salvador** — Especialización en Gestión de Sistemas de Información  
  Formación orientada a procesos, información, soporte a la decisión y gestión tecnológica.
...
- Portfolio: [santiagosilvestri.dev](https://santiagosilvestri.dev)
- Email: silvestrisantiago@gmail.com
